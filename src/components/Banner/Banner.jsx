...
function Banner({ query, handleInputChange }) {
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4 space-x-5">
          ...
          <button
            type="submit"
            className="py-2 px-8 border md:rounded-s-none rounded bg-blue text-white   hover:bg-cyan-950"
          >
            Search
          </button>
        </div>
